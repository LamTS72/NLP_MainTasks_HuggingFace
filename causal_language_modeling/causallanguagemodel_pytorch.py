...
class CausalLM(object):
    ...
    def load_dataset(self, name1="huggingface-course/codeparrot-ds-train", name2= "huggingface-course/codeparrot-ds-valid"):
        ...
        self.raw_dataset = DatasetDict(
            {
                "train":  train_dataset.shuffle().select(range(100000)),
...
if __name__ == "__main__":
    ...
    clm.map_tokenize_dataset(path="./root/project")

    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    4_SELECTION HYPERPARMETERS
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

    clm.create_argumentTrainer(num_train_epochs=1, push_to_hub=True, hub_model_id="Chessmen/"+"fine_tune_" + clm.other_name)
